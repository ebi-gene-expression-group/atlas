...
JAVA_OPTIONS="-Dsolr.indexes.dir=/srv/gxa/solr -Dsolr.solr.home=./solr -Djava.util.logging.config.file=solr_test/logging.properties -server -DSTOP.PORT=8079 -DSTOP.KEY=stopkey -Xmx8192M -Xms1024M -jar start.jar"
