...
class JsonLandingSpeciesCardControllerWIT {
    private static final String URL = "/json/landingpage/species/{species}";
    ...
    @ParameterizedTest
    @MethodSource("speciesProvider")
    void validSpecies(String species) throws Exception {
        mockMvc.perform(get(URL, species))
    ...
    private Iterable<String> speciesProvider() {
        return jdbcUtils.fetchSpeciesForSingleCellExperiments();
    }
}
