...
<div id="people" class="callout" data-equalizer-watch>
    ...
    <div class="row">
        <div class="medium-6 columns">
            ...
            <a href="https://www.sanger.ac.uk/people/directory/vladimir-yu-kiselev" target="_blank">
                <div class="media-object">
                    <div class="media-object-section middle">
                        <span class="icon icon-generic" data-icon="M"></span>
                    </div>
                    <div class="media-object-section middle">
                        <p>
                            <strong>Kiselev</strong> - Wellcome Sanger Institute
                        </p>
                    </div>
                </div>
            </a>
        ...
        <div class="medium-6 columns">
            <a href="https://www.sanger.ac.uk/people/directory/meyer-kerstin" target="_blank">
                <div class="media-object">
                    <div class="media-object-section middle">
                        <span class="icon icon-generic" data-icon="M"></span>
                    </div>
                    <div class="media-object-section middle">
                        <p>
                            <strong>Meyer</strong> - Wellcome Sanger Institute
                        </p>
                    </div>
                </div>
            </a>
