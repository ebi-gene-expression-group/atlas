...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.render = function (options) {
	    ...
	    ReactDOM.render(React.createElement(ReferencePlotContainer, { referenceDataSourceUrlTemplate: options.referenceDataSourceUrlTemplate }), typeof options.target === "string" ? document.getElementById(options.target) : options.target);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReferencePlotContainer = React.createClass({
	  ...
	  _fetchExpressionPlotData: function _fetchExpressionPlotData(chosenItem) {
	    var _this = this;

	    if (chosenItem.value) {
	      var url = this.props.referenceDataSourceUrlTemplate.replace(/\{0\}/, JSON.stringify([chosenItem]));
	      this.setState({ loading: true }, fetchExpressionData(chosenItem, url, function (expressionData) {
	        _this.setState({
	          loading: false,
...
/***/ function(module, exports) {
	...
	module.exports = [
		{
			"from": 0.0416898784026232,
			"to": 0.1320758934094855,
			"color": "#0000ff"
		},
		{
			"from": 0.1320758934094855,
			"to": 0.22246190841634778,
			"color": "#3333ff"
		},
		{
			"from": 0.22246190841634778,
			"to": 0.31284792342321005,
			"color": "#6666ff"
		},
		{
			"from": 0.31284792342321005,
			"to": 0.4032339384300723,
			"color": "#9999ff"
		},
		{
			"from": 0.4032339384300723,
			"to": 0.4936199534369346,
			"color": "#ccccff"
		},
		{
			"from": 0.4936199534369346,
			"to": 0.5840059684437969,
			"color": "#ffffff"
		},
		{
			"from": 0.5840059684437969,
			"to": 0.6743919834506592,
			"color": "#ffcccc"
		},
		{
			"from": 0.6743919834506592,
			"to": 0.7647779984575215,
			"color": "#ff9999"
		},
		{
			"from": 0.7647779984575215,
			"to": 0.8551640134643838,
			"color": "#ff6666"
		},
		{
			"from": 0.8551640134643838,
			"to": 0.945550028471246,
			"color": "#ff3333"
		},
		{
			"from": 0.945550028471246,
			"to": 1.0359360434781084,
			"color": "#ff0000"
		}
	];
