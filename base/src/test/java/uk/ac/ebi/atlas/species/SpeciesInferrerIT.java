...
public class SpeciesInferrerIT {
    ...
    static final String GLYCINE_MAX = "glycine max";

    static final SemanticQueryTerm HUMAN_REACTOME_TERM = SemanticQueryTerm.create("R-HSA-597592", "pathwayid");
    static final SemanticQueryTerm PLANT_REACTOME_TERM = SemanticQueryTerm.create("R-GMA-2744341", "pathwayid");
    ...
    static final SemanticQuery PLANT_GENE_QUERY = SemanticQuery.create(PLANT_REACTOME_TERM);
