...
public class BaselineExperimentTest {
    ...
    private static List<AssayGroup> assayGroups = ImmutableList.of(
            new AssayGroup("g1", RUN_ACCESSION1),
            new AssayGroup("g2", RUN_ACCESSION2));

    @Test
    public void testGetExperimentRunAccessions() {
        BaselineExperiment subject = MockExperiment.createBaselineExperiment(assayGroups);
    ...
    public void orderOfAssayGroupsIsPreserved(){
        ...
        assertThat(MockExperiment.createBaselineExperiment(assayGroups).getDataColumnDescriptors()).hasSameElementsAs(assayGroups);
    }
}