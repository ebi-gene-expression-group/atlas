...
public class ExperimentDesignParserWithOntologyTermsTest {
    ...
    public void testParseSamples() {
        ExperimentDesign experimentDesign = subject.parse(EXPERIMENT_ACCESSION);
        assertThat(
                experimentDesign.getSampleCharacteristicValue(ASSAY_ACCESSION_1, CHARACTERISTIC_1),
                is(RD_INSTAR_LARVA));
        assertThat(
                experimentDesign.getSampleCharacteristicValue(ASSAY_ACCESSION_2, CHARACTERISTIC_1),
                is(RD_INSTAR_LARVA));
