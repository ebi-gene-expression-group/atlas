...
public class SortStreamBuilder<T extends CollectionProxy> extends TupleStreamBuilder<T> {
    private final TupleStreamBuilder<T> tupleStreamBuilder;
    private final String fieldName;
    private final boolean descending;

    public SortStreamBuilder(TupleStreamBuilder<T> tupleStreamBuilder, String fieldName) {
