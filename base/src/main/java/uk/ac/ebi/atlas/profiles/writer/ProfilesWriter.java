...
public class ProfilesWriter<Prof extends Profile> {
    ...
    public ProfilesWriter(Writer responseWriter, String masthead, String[] columnHeaders, Function<Prof, String[]> profileToLine){
