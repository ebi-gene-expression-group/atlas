...
public class DataFileHub {
    ...
    final static String SPECIES_PROPERTIES_FILE_PATH = "/rdf/species/species-properties.json";
    ...
    final static String EXPERIMENT_DESIGN_FILE_PATH_TEMPLATE = "/rdf/expdesign/ExpDesign-{0}.tsv";
