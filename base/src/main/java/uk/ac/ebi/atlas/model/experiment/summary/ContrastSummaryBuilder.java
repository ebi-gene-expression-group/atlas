...
public class ContrastSummaryBuilder {
    ...
    public ContrastSummary build() {
        ...
        for (String assay : contrast.getReferenceAssayGroup().assaysAnalyzedForThisDataColumn()) {
        ...
        for (String assay : contrast.getTestAssayGroup().assaysAnalyzedForThisDataColumn()) {
