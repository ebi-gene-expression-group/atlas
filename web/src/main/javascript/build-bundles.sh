...
all_packages=(anatomogram cell-differential contrast-tooltips display-levels-button heatmap-baseline-cell-variance help-tooltips legend number-format expression-atlas-anatomogram expression-atlas-heatmap expression-atlas-heatmap-highcharts faceted-search)
