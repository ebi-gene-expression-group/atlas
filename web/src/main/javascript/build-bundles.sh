...
all_packages=(anatomogram atlas-feedback cell-differential contrast-tooltips display-levels-button download-profiles-button heatmap-baseline-cell-variance help-tooltips legend number-format expression-atlas-anatomogram expression-atlas-heatmap expression-atlas-heatmap-highcharts faceted-search expression-atlas-heatmap-highcharts-old)
bundled_packages=(expression-atlas-anatomogram expression-atlas-heatmap expression-atlas-heatmap-highcharts expression-atlas-heatmap-highcharts-old faceted-search)
