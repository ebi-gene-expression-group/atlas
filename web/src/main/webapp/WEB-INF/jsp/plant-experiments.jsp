...
<div class="grid_24" id="species-nav">
        ...
        <div class="grid_26 alpha" style="padding-top: 20px">
            ...
            <div class="grid_18 omega">
                ...
                <p>
                    ...
                    <a href="https://code.google.com/p/irap/">iRAP</a> pipeline.</p>
    ...
    <c:forEach items="${baselineExperimentAccessionsBySpecies.keySet()}" var="specie">
    ...
    <div class="grid_24 alpha" style="padding-top: 20px">
        <div class="page-header">
            ...
            <c:forEach items="${numDifferentialExperimentsBySpecies.keySet()}" var="specie">
