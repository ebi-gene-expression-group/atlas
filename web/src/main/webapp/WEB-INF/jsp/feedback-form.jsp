...
<script>
    $(function() {
        ...
        $( "#dialog-form" ).dialog({
            ...
            width: 395,
            modal: true,
            buttons: [{width:"60px", text:"Send", id: "send-button", click: function() {
                    var bValid = true;
        ...
        <fieldset id="form-fields">
            <ul>
                <li>
                    ...
                    <div>
                        <textarea rows="4" cols="50"  name="feedback" id="feedback" class="text ui-widget-content ui-corner-all"></textarea>
                    </div>
                </li>
                <li>
                    <div>
                    ...
                    <div>
                        <input type="input" size="50" maxlength="80" name="email" id="email" value="" class="text ui-widget-content ui-corner-all" />
                    </div>
                </li>
            </ul>
        </fieldset>
