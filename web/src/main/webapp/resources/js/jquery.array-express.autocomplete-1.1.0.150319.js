...
$.Autocompleter = function(input, options) {
	...
	$.browser.opera && $(input.form).bind("submit.arrayExpressAutocomplete", function() {
		if (blockSubmit) {
			blockSubmit = false;
			return false;
		}
	...
	$input.bind(($.browser.opera ? "keypress" : "keydown") + ".arrayExpressAutocomplete", function(event) {
