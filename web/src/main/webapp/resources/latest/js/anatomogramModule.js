...
var anatomogramModule = (function ($) {
    ...
    function init(allSvgPathIds, fileNameMale, fileNameFemale, contextRoot, species, isSingleGene, heatmapkey) {
        ...
        var svg = loadAnatomogram(anatomogramBody, contextRoot + "/resources/latest/svg/" + fileNameMale, allSvgPathIds, isSingleGene);
        ...
        if (fileNameMale !== fileNameFemale) {
            ...
            $(sexToggleImage).button().toggle(
                function () {
                    ...
                    loadAnatomogram(anatomogramBody, contextRoot + "/resources/latest/svg/" + fileNameFemale, allSvgPathIds, isSingleGene);
                },
                function () {
                    $(this).attr("src", contextRoot + selectMaleImageToggle(species));
                    loadAnatomogram(anatomogramBody, contextRoot + "/resources/latest/svg/" + fileNameMale, allSvgPathIds, isSingleGene);
                }
            ).tooltip();
        } else {
            $(sexToggle).hide();
    ...
    function selectFemaleImageToggle (species) {
        return (species === "oryza sativa japonica group" || species === "oryza sativa" ? "/resources/latest/images/plant_switch_buttons_2.png" : "/resources/images/female_selected.png");
    }

    function selectMaleImageToggle (species) {
        return (species === "oryza sativa japonica group" || species === "oryza sativa" ? "/resources/latest/images/plant_switch_buttons_1.png" : "/resources/images/male_selected.png");
    }
