...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0), function (e, t, n) {
    ...
    var x = e.event.add, k = e.event.remove, N = e.event.trigger, T = e.fn.toggle, M = e.fn.live, S = e.fn.die, C = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", A = RegExp("\\b(?:" + C + ")\\b"), H = /(?:^|\s)hover(\.\S+|)\b/, L = function (t) {
