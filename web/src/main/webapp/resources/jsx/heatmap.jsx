    ...
    var build = function build(type, heatmapConfig, eventEmitter, $prefFormDisplayLevelsInputElement) {
                ...
                return (
                    <div>
                        ...
                        <div id="gxaExperimentPageHeatmapTableStickyWrapper" style={{"padding-top": "10px"}}>
                            ...
                            <table className="gxaTableGrid" id="gxaExperimentPageHeatmapTableStickyWrapperStickyIntersect">
                            ...
                            <table className="gxaTableGrid" id="gxaExperimentPageHeatmapTableStickyWrapperStickyHeader">
                            ...
                            <table className="gxaTableGrid" id="gxaExperimentPageHeatmapTableStickyWrapperStickyColumn">
        ...
        var FactorHeaders = React.createClass({
            ...
            render: function () {
                ...
                return (
                    <div className="gxaHeatmapTableHeader">{factorHeaders}</div>
                    );
            }
        ...
        var ContrastHeaders = React.createClass({
            ...
            render: function () {
                ...
                return (
                    <div className="gxaHeatmapTableHeader">{contrastHeaders}</div>
                    );
            }
        ...
        var GeneProfileRow = (function (contextRoot, toolTipHighlightedWords, isExactMatch, enableGeneLinks, enableEnsemblLauncher, geneQuery) {
            ...
            return React.createClass({
                ...
                render: function () {
                    ...
                    var showTickWhenSelected = this.props.selected ? <span style={{"padding-top": "2px", "float": "right", "color": "green"}}> &#10004; </span>: null ;
