    ...
    var build = function build(type, heatmapConfig, eventEmitter, $prefFormDisplayLevelsInputElement) {
        ...
        var Heatmap = React.createClass({
            ...
            render: function () {
                return (
                    <div>
                        <div ref="countAndLegend" id="gxaExperimentPageHeatmapCountAndLegend" style={{"padding-bottom": "15px"}}>
                        ...
                        <div ref="stickyWrapper" className="gxaHeatmapTableStickyWrapper" style={{"margin-top": "15px"}}>
                            <table ref="heatmapTable" className="gxaTableGrid">
                            ...
                            <table ref="stickyIntersect" className="gxaTableGrid gxaHeatmapTableStickyWrapperStickyIntersect">
                            ...
                            <table ref="stickyHeader" className="gxaTableGrid gxaHeatmapTableStickyWrapperStickyHeader">
                            ...
                            <table ref="stickyColumn" className="gxaTableGrid gxaHeatmapTableStickyWrapperStickyColumn">
