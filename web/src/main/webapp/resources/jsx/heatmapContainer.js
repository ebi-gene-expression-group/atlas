        ...
        render: function () {
            ...
            return (
                ...
                React.DOM.div( {id:"content", className:"grid_24"}, 
                    ...
                    React.DOM.div( {id:"transcript-breakdown", style:{display:"none", height: "320px", width: "500px", "padding-top":"10px"}}, 
                        React.DOM.p( {style:{"text-align": "center"}}, 
                            React.DOM.span( {id:"transcript-breakdown-title"}),
                            React.DOM.span( {id:"transcript-breakdown-title-help"}, 
                                React.DOM.a( {className:"help-icon", href:"#",
                                title:"Transcripts with zero expression are excluded from the pie chart. Transcripts shown in white colour have been reported with low confidence."}, "?")
                            )
                        ),

                        React.DOM.div(null, 
                            React.DOM.div( {id:"transcripts-pie", style:{width: "500px", height:"250px"}}
                            )
                        )
                    ),
