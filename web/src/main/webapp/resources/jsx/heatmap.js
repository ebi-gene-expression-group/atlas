        ...
        var GeneProfileRow = (function (contextRoot, toolTipHighlightedWords, isExactMatch, enableGeneLinks, enableEnsemblLauncher, geneQuery) {
            ...
            return React.createClass({
                ...
                geneNameLinked: function () {
                    ...
                    return (
                        React.DOM.div( {className:"icon icon-conceptual icon-c2", title:titleTooltip, 'data-icon':type.isMultiExperiment ? (this.props.experimentType == "PROTEOMICS_BASELINE" ? 'P' : 'd') : ''}, React.DOM.a( {ref:"geneName", title:"", id:this.props.showGeneSetProfiles ? '' : this.props.id, href:contextRoot + url, onClick:this.geneNameLinkClicked}, this.props.name))
                        );
                },
