...
@Named
@Scope("singleton")
public class BaselineCoexpressionsInputStreamFactory {

    private final CsvReaderFactory csvReaderFactory;
    private final String fileTemplate;

    @Inject
    public BaselineCoexpressionsInputStreamFactory(@Value("#{configuration['experiment.coexpression_matrix.template']}") String fileTemplate,
                                                   CsvReaderFactory csvReaderFactory) {
        this.fileTemplate = fileTemplate;
        this.csvReaderFactory = csvReaderFactory;
    }

    public BaselineCoexpressionsInputStream create(String experimentAccession) {
        ...
        return new BaselineCoexpressionsInputStream(csvReader, tsvGzFilePath);
    }
}
