...
@Named
public class SearchTimingInterceptor extends HandlerInterceptorAdapter {

    private static final Logger LOGGER = Logger.getLogger(SearchTimingInterceptor.class);
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) {
        ...
        LOGGER.info("time taken " + stopWatch.getTotalTimeSeconds()
