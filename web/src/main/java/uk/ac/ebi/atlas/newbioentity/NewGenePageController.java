...
public class NewGenePageController extends NewBioentityPageController {
    ...
    @RequestMapping(value ={"/genes/{identifier:.*}/differentialFacets.json", "/rest/genes/{identifier:.*}/differentialFacets.json"}, method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    @ResponseBody
    ...
    @RequestMapping(value ={"/genes/{identifier:.*}/differentialResults.json", "/rest/genes/{identifier:.*}/differentialResults.json"}, method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    @ResponseBody
