...
//    }
//
//    public DifferentialBioentityExpressions buildDifferentialBioentityExpressions(String geneIdentifier, double cutoff) {
//
//        List<DifferentialBioentityExpression> differentialBioentityExpressions = Lists.newArrayList();
//
//        String species = solrQueryService.findSpeciesForBioentityId(geneIdentifier);
...
//            buildMatureRNADifferentialProfilesForIdentifier(mirbaseIds.iterator().next(), cutoff, species);
//        } else {
//            buildMatureRNADifferentialProfilesForIdentifier(geneIdentifier, cutoff, species);
//        }
//
...
//
//
//    private List<DifferentialBioentityExpression>  buildMatureRNADifferentialProfilesForIdentifier(String geneIdentifier, double cutoff, String species) {
//        List<DifferentialBioentityExpression> differentialBioentityExpressions = Lists.newArrayList();
//
//        Set<String> matureRNAsForMirbaseId = solrQueryService.fetchGeneIdentifiersFromSolr(geneIdentifier, "mirna", false"hairpin_id");
//        if (matureRNAsForMirbaseId.size() > 0) {
//
//            for (String matureRNAIdentifier : matureRNAsForMirbaseId) {
//                differentialBioentityExpressions.addAll(processDifferentialProfilesForIdentifier(matureRNAIdentifier, cutoff, species));
//            }
//        } else {
//            differentialBioentityExpressions.addAll(processDifferentialProfilesForIdentifier(geneIdentifier, cutoff, species));
//        }
//
//        return differentialBioentityExpressions;
//    }
//
//    private List<DifferentialBioentityExpression> processDifferentialProfilesForIdentifier(String identifier, double cutoff, String species) {
//
//        List<DifferentialBioentityExpression> differentialBioentityExpressions = Lists.newArrayList();
//
...
//                differentialBioentityExpressions.addAll(buildDifferentialBioentityExpressions(experimentAccession, differentialProfilesList, species));
//
...
//    }
//
//    private List<DifferentialBioentityExpression> buildDifferentialBioentityExpressions(String experimentAccession,
