...
public class BaselineCoexpressionsProfileLoader {
    ...
    private final BaselineCoexpressionsProfileDAO baselineCoexpressionsProfileDAO;
    private final BaselineCoexpressionsProfileInputStreamFactory baselineCoexpressionsProfileInputStreamFactory;

    @Inject
    public BaselineCoexpressionsProfileLoader(BaselineCoexpressionsProfileDAO baselineCoexpressionsProfileDAO, BaselineCoexpressionsProfileInputStreamFactory baselineCoexpressionsProfileInputStreamFactory) {
