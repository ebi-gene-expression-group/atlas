...
public class ExperimentDesignTsvReader {

    private static final Logger logger = Logger.getLogger(ExperimentDesignTsvReader.class);

    private ApplicationProperties applicationProperties;

    @Inject
    public ExperimentDesignTsvReader(ApplicationProperties applicationProperties) {
