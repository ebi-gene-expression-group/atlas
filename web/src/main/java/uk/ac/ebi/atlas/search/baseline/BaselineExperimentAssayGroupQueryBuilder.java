...
public class BaselineExperimentAssayGroupQueryBuilder {
    ...
    static final String SELECT_QUERY_PROTEOMICS = "SELECT DISTINCT rbe.experiment, rbe.assaygroupid from RNASEQ_BSLN_EXPRESSIONS partition( BSLN_EXPRESSIONS_ACTIVE ) rbe ";
