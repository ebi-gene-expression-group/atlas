...
public class AllDataWriterFactory {
    ...
    @Inject
    public AllDataWriterFactory(TsvReaderBuilder tsvReaderBuilder, GeneNamesProvider geneNamesProvider, DesignElementMappingProvider designElementMappingProvider) {
    ...
    public ExpressionsWriter getRnaSeqAnalyticsDataWriter(DifferentialExperiment experiment, PrintWriter responseWriter) {
        ...
        ExpressionsWriterImpl expressionsWriter = new ExpressionsWriterImpl(tsvReaderBuilder, geneNamesProvider);
    ...
    public ExpressionsWriter getMicroarrayAnalyticsDataWriter(DifferentialExperiment experiment, String arrayDesignAccession, PrintWriter responseWriter) {
        ...
        MicroarrayDataWriter microarrayDataWriter = new MicroarrayDataWriter(tsvReaderBuilder, geneNamesProvider, designElementMappingProvider);
