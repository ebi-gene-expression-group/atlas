...
DROP TABLE GENE_COEXPRESSION;
CREATE TABLE GENE_COEXPRESSION (
  EXPERIMENT VARCHAR2(255) NOT NULL,
  IDENTIFIER VARCHAR(255) NOT NULL,
...
CREATE INDEX PK_COEXPRESSED_GENE ON GENE_COEXPRESSION (EXPERIMENT, IDENTIFIER, CE_IDENTIFIER) TABLESPACE ATLASPRD3_INDX;
ALTER TABLE GENE_COEXPRESSION
