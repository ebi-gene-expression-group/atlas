...
ALTER TABLE MICROARRAY_DIFF_ANALYTICS
  ...
  PRIMARY KEY (DESIGNELEMENT, EXPERIMENT, CONTRASTID, PVAL, ISACTIVE)
ENABLE;
...
ALTER TABLE RNASEQ_DIFF_ANALYTICS
  ...
  PRIMARY KEY (IDENTIFIER, EXPERIMENT, CONTRASTID, PVAL, ISACTIVE)
ENABLE;
...
ALTER TABLE RNASEQ_BSLN_EXPRESSIONS
  ...
  PRIMARY KEY (IDENTIFIER, EXPERIMENT, ASSAYGROUPID, EXPRESSION, ISACTIVE)
ENABLE;
...
ALTER TABLE RNASEQ_BSLN_TRANSCRIPTS
  ...
  PRIMARY KEY (EXPERIMENT, GENE_IDENTIFIER, TRANSCRIPT_IDENTIFIER, ISACTIVE)
ENABLE;
