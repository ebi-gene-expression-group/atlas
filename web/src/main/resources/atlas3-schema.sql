...
ALTER TABLE EXPERIMENT ADD PUBMED_IDS VARCHAR2(255);

ALTER TABLE EXPERIMENT ADD TITLE VARCHAR2(255);
...
CREATE TABLE EXPERIMENT_SPECIES(
    SPECIES_NAME VARCHAR(255) NOT NULL,
    EXPERIMENT_ACCESSION VARCHAR(255) NOT NULL
);

CREATE INDEX ES_EXPERIMENT_ACCESSION ON EXPERIMENT_SPECIES (EXPERIMENT_ACCESSION) TABLESPACE ATLASPRD3_INDX;
ALTER TABLE EXPERIMENT_SPECIES
  ADD CONSTRAINT FK_EXPERIMENT_SPECIES FOREIGN KEY (EXPERIMENT_ACCESSION) REFERENCES EXPERIMENT(ACCESSION) ON DELETE CASCADE
ENABLE;
