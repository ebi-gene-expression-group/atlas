...
public class ExperimentTest {
    ...
    public void testFilteredFactorValues() {
        ...
        assertThat(subject.getFilteredFactorValues(Sets.newHashSet(factorValue1), "ORGANISM_PART"), hasItems(factorValue1));
        ...
        assertThat(subject.getFilteredFactorValues(Sets.newHashSet(factorValue3, factorValue4), "ORGANISM_PART"), hasItems(factorValue3));
        assertThat(subject.getFilteredFactorValues(Sets.newHashSet(factorValue2), "ORGANISM_PART").size(), is(1));
        assertThat(subject.getFilteredFactorValues(Sets.newHashSet(factorValue2), "ORGANISM_PART"), hasItems(factorValue2));
        assertThat(subject.getFilteredFactorValues(Sets.newHashSet(factorValue3), "MATERIAL_TYPE").size(), is(1));
        assertThat(subject.getFilteredFactorValues(Sets.newHashSet(factorValue3), "MATERIAL_TYPE"), hasItems(factorValue4));
    }
