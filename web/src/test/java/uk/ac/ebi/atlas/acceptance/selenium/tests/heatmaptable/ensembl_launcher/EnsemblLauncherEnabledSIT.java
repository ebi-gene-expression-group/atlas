...
package uk.ac.ebi.atlas.acceptance.selenium.tests.heatmaptable.ensembl_launcher;
...
public class EnsemblLauncherEnabledSIT extends SinglePageSeleniumFixture {
    ...
    public void diffExperimentWithTracksShouldHaveEnsemblLauncher() {
        HeatmapTablePage subject = new HeatmapTablePage(driver, "E-GEOD-3779", "foldChangeCutOff=0&cutoff=1");
        subject.get();
