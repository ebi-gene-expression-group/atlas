...
public class BaselineExperimentProfileSearchServiceIT {
    ...
    public void singleSpeciesGeneSet() {
        ...
        assertThat(baselineProfile0.getMinExpressionLevel(), is(0.7D));
        assertThat(baselineProfile0.getMaxExpressionLevel(), is(13D));
        assertThat(baselineProfile0.getKnownExpressionLevel(ADIPOSE), is(9D));
        assertThat(baselineProfile0.getKnownExpressionLevel(ADRENAL_GLAND), is(8D));
        assertThat(baselineProfile0.getKnownExpressionLevel(ANIMAL_OVARY), is(7D));
        assertThat(baselineProfile0.getKnownExpressionLevel(APPENDIX), is(13D));
        assertThat(baselineProfile0.getKnownExpressionLevel(BLADDER), is(9D));
        assertThat(baselineProfile0.getKnownExpressionLevel(BONE_MARROW), is(11D));
        ...
        assertThat(baselineProfile0.getKnownExpressionLevel(ENDOMETRIUM), is(8D));
        ...
        assertThat(baselineProfile0.getKnownExpressionLevel(KIDNEY), is(5D));
        assertThat(baselineProfile0.getKnownExpressionLevel(LIVER), is(6D));
        assertThat(baselineProfile0.getKnownExpressionLevel(LUNG), is(12D));
        assertThat(baselineProfile0.getKnownExpressionLevel(LYMPH_NODE), is(12D));
        ...
        assertThat(baselineProfile0.getKnownExpressionLevel(PANCREAS), is(0.7D));
        assertThat(baselineProfile0.getKnownExpressionLevel(PLACENTA), is(7D));
        assertThat(baselineProfile0.getKnownExpressionLevel(PROSTATE), is(7D));
        assertThat(baselineProfile0.getKnownExpressionLevel(RECTUM), is(13D));
        assertThat(baselineProfile0.getKnownExpressionLevel(SALIVARY_GLAND), is(3D));
        assertThat(baselineProfile0.getKnownExpressionLevel(SKELETAL_MUSCLE), is(2D));
        assertThat(baselineProfile0.getKnownExpressionLevel(SKIN), is(6D));
        assertThat(baselineProfile0.getKnownExpressionLevel(SMALL_INTESTINE), is(9D));
        assertThat(baselineProfile0.getKnownExpressionLevel(SMOOTH_MUSCLE), is(7D));
        assertThat(baselineProfile0.getKnownExpressionLevel(SPLEEN), is(12D));
        assertThat(baselineProfile0.getKnownExpressionLevel(STOMACH), is(6D));
        assertThat(baselineProfile0.getKnownExpressionLevel(TESTIS), is(3D));
        assertThat(baselineProfile0.getKnownExpressionLevel(THYROID), is(6D));
        assertThat(baselineProfile0.getKnownExpressionLevel(TONSIL), is(10D));
        ...
        assertThat(baselineProfile1.getMaxExpressionLevel(), is(25D));
        assertThat(baselineProfile1.getKnownExpressionLevel(ADIPOSE), is(14D));
        assertThat(baselineProfile1.getKnownExpressionLevel(ADRENAL_GLAND), is(16D));
        assertThat(baselineProfile1.getKnownExpressionLevel(ANIMAL_OVARY), is(11D));
        assertThat(baselineProfile1.getKnownExpressionLevel(APPENDIX), is(23D));
        assertThat(baselineProfile1.getKnownExpressionLevel(BLADDER), is(23D));
        assertThat(baselineProfile1.getKnownExpressionLevel(BONE_MARROW), is(20D));
        assertThat(baselineProfile1.getKnownExpressionLevel(CEREBRAL_CORTEX), is(7D));
        assertThat(baselineProfile1.getKnownExpressionLevel(COLON), is(17D));
        assertThat(baselineProfile1.getKnownExpressionLevel(DUODENUM), is(19D));
        assertThat(baselineProfile1.getKnownExpressionLevel(ENDOMETRIUM), is(14D));
        assertThat(baselineProfile1.getKnownExpressionLevel(ESOPHAGUS), is(15D));
        assertThat(baselineProfile1.getKnownExpressionLevel(GALL_BLADDER), is(20D));
        assertThat(baselineProfile1.getKnownExpressionLevel(HEART), is(9D));
        assertThat(baselineProfile1.getKnownExpressionLevel(KIDNEY), is(15D));
        assertThat(baselineProfile1.getKnownExpressionLevel(LIVER), is(12D));
        assertThat(baselineProfile1.getKnownExpressionLevel(LUNG), is(25D));
        assertThat(baselineProfile1.getKnownExpressionLevel(LYMPH_NODE), is(20D));
        assertThat(baselineProfile1.getKnownExpressionLevel(PANCREAS), is(3D));
        assertThat(baselineProfile1.getKnownExpressionLevel(PLACENTA), is(18D));
        assertThat(baselineProfile1.getKnownExpressionLevel(PROSTATE), is(14D));
        assertThat(baselineProfile1.getKnownExpressionLevel(SALIVARY_GLAND), is(9D));
        assertThat(baselineProfile1.getKnownExpressionLevel(SKIN), is(13D));
        assertThat(baselineProfile1.getKnownExpressionLevel(SMALL_INTESTINE), is(19D));
        assertThat(baselineProfile1.getKnownExpressionLevel(SPLEEN), is(18D));
        assertThat(baselineProfile1.getKnownExpressionLevel(STOMACH), is(13D));
        assertThat(baselineProfile1.getKnownExpressionLevel(TESTIS), is(12D));
