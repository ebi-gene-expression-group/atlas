...
public class GeneSetUtilTest {
    ...
    public void testIsGeneSet() throws Exception {
        ...
        assertTrue(GeneSetUtil.isGeneSetSourceOrMatchesGeneSetAccession(SemanticQuery.create(Sets.union(GENE_QUERY_WITH_GENE_SET_SOURCES.terms(), GENE_QUERY_WITH_GENE_SET_VALUES.terms()))));
    }
}