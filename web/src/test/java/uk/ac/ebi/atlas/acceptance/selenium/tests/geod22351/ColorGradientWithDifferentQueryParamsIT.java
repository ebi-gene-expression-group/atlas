...
public class ColorGradientWithDifferentQueryParamsIT extends SeleniumFixture {
    ...
    public void verifyUpGradientLevelsAreShowingAndCorrect() {
        ...
        List<String> gradientMinLabels = subject.getGradientMinLabels();
        List<String> gradientMaxLabels = subject.getGradientMaxLabels();
    ...
    public void verifyUpGradientStartAndEndColor() {
        ...
        List<String> startColor = subject.getGradientStartColor();
        List<String> endColor = subject.getGradientEndColor();
