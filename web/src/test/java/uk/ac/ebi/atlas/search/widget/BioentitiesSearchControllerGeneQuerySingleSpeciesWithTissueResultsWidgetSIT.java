...
public class BioentitiesSearchControllerGeneQuerySingleSpeciesWithTissueResultsWidgetSIT extends SinglePageSeleniumFixture {

    private BioEntitiesPage subject;

    @Override
    protected void getStartingPage() {
        subject = BioEntitiesPage.search(driver, "geneQuery=%22zinc+finger%22&organism=Homo+sapiens");
        subject.get();
    }
