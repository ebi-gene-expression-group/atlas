...
public class BioentitiesSearchControllerGeneQuery2GeneSetsMultipleExperimentResultsFromSameSpeciesWidgetSIT extends SinglePageSeleniumFixture {
    ...
    public void displaysWidget() {
        ...
        assertThat(subject.getGeneLink(2), endsWith("/experiments/E-PROT-1?geneQuery=REACT_152%09REACT_111102&serializedFilterFactors=DEVELOPMENTAL_STAGE%3Aadult"));
        assertThat(subject.getGeneLink(3), endsWith("/experiments/E-MTAB-513?geneQuery=REACT_152%09REACT_111102"));
