...
public class GeneSetPageControllerMultiSpeciesGeneSetBaselineCountsSIT extends SeleniumFixture {
    ...
    public void baselineResults() {
        assertThat(subject.getBaselinePaneHeaderResultsMessage(), is("20 results"));

        List<BaselineBioEntitiesSearchResult> baselineCounts = subject.getBaselineCounts();

        assertThat(baselineCounts, hasSize(21)); //including geneset description

        BaselineBioEntitiesSearchResult result1 = baselineCounts.get(11);
        ...
        BaselineBioEntitiesSearchResult result2 = baselineCounts.get(12);
        ...
        BaselineBioEntitiesSearchResult result3 = baselineCounts.get(13);
        ...
        BaselineBioEntitiesSearchResult result4 = baselineCounts.get(14);
        ...
        BaselineBioEntitiesSearchResult result5 = baselineCounts.get(15);
        ...
        BaselineBioEntitiesSearchResult result6 = baselineCounts.get(16);
        ...
        BaselineBioEntitiesSearchResult result7 = baselineCounts.get(17);
        ...
        BaselineBioEntitiesSearchResult result8 = baselineCounts.get(18);
        ...
        BaselineBioEntitiesSearchResult result9 = baselineCounts.get(19);
        ...
        BaselineBioEntitiesSearchResult result10 = baselineCounts.get(20);
