...
public class GeneSetPageControllerMultiSpeciesGeneSetBaselineCountsSIT extends SeleniumFixture {
    ...
    public void baselineResults() {
        ...
        assertThat(subject.getBaselinePaneHeaderResultsMessage(), is("44 results"));

        List<BaselineBioEntitiesSearchResult> baselineCounts = subject.getAllBaselineResults();

        assertThat(baselineCounts, hasSize(44));
        ...
        BaselineBioEntitiesSearchResult result2 = baselineCounts.get(20);
        ...
        BaselineBioEntitiesSearchResult result3 = baselineCounts.get(30);
