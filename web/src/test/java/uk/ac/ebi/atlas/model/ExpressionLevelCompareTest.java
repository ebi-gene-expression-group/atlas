...
public class ExpressionLevelCompareTest {
    ...
    public void initializeSubject() {
        subject = new ExpressionLevel("id", 100.0000).addFactorValue("f1", "v1")
    ...
    public void compareToShouldReturnNegativeIntegerWhenRPKMIsLowerThanOther() {
        //given
        ExpressionLevel other = new ExpressionLevel("id", 100.000001).addFactorValue("f1", "v1")
                .addFactorValue("f2", "v2");
        //then
    ...
    public void compareToShouldReturnPositiveIntegerWhenRPKMIsGreaterThanOther() {
        //given
        ExpressionLevel other = new ExpressionLevel("id", 99.999999).addFactorValue("f1", "v1")
                .addFactorValue("f2", "v2");
        //then
