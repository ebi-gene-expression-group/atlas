...
public class BaselineProfilesWriterIT {
    ...
    public void eMTab513_Specific_MultipleGeneSets() throws GenesNotFoundException {
        ...
        assertThat(react_111217, is(new String[]{"react_111217", "8", "681", "17", "8", "8", "9", "10", "275", "11", "440", "500", "430", "9", "8", "15", "550"}));
        assertThat(react_12627, is(new String[] {"react_12627", "2", "4", "3", "3", "2", "2", "4", "4", "1", "2", "3", "5", "5", "2", "6", "5"}));
    }
...
//    @Ignore
    ...
    // Enable after https://www.pivotaltracker.com/story/show/93529544 has been fixed
    @Ignore
    public void eMTab513react71_Specific_GeneSet_QueryFactorProstateGeneSet_CheckExpressionLevelsForReact71() throws GenesNotFoundException {
        ...
        assertThat(react_71, is(new String[] {"react_71", "6", "9", "6", "5", "8", "5", "5", "11", "4", "6", "8", "9", "16", "9", "16", "8"}));
    }
