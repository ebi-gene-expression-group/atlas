...
public class DifferentialAnalyticsSearchServiceIT extends TestCase {
    ...
    public void fetchDifferentialGeneQuerySelectionResultsAsJson() throws Exception {
        ...
        OldGeneQuery geneQuery = OldGeneQuery.create("zinc finger");

        String json = subject.fetchDifferentialResultsForSearch(geneQuery, species, experimentTypes, kingdoms, factors, null, null);

        assertTrue(!json.isEmpty());

        // TODO E-MTAB-698 isn’t included until https://www.pivotaltracker.com/story/show/101118548
        // assertThat(json, is("" +
