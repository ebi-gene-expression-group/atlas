...
public class DifferentialAnalyticsSearchServiceIT extends TestCase {
    ...
    public void fetchDifferentialGeneQuerySelectionResultsAsJson() throws Exception {
        ...
        assertThat(json, is("[{\"geneCount\":98,\"organism\":\"mus musculus\",\"contrastId\":\"g1_g2\",\"comparison\":\"clinical information:'non-pregnant' vs 'pregnant'\",\"experimentAccession\":\"E-GEOD-21860\",\"experimentName\":\"RNA-seq of pancreatic islets from pregnant mice\"}]"));
    }
}