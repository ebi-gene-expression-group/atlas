...
public class GenePageControllerPropertiesSIT extends SinglePageSeleniumFixture {
    ...
    public void infoCard() {
        ...
        assertThat(subject.getPropertiesTableRow(0), hasItems("Synonyms", "DC-HIL, Dchil, Osteoactivin"));
        assertThat(subject.getPropertiesTableRow(1), hasItems("Orthologs", "GPNMB (Bos taurus), GPNMB (Canis familiaris), gpnmb (Danio rerio), GPNMB (Equus caballus), GPNMB (Homo sapiens), GPNMB (Gallus gallus), GPNMB (Macaca mulatta), Gpnmb (Rattus norvegicus), gpnmb (Xenopus tropicalis)"));
        assertThat(subject.getPropertiesTableRow(2), hasItems("Gene Ontology", "negative regulation of tumor necrosis factor production, melanosome, osteoblast differentiation, integrin binding, cytoplasmic membrane-bounded vesicle, bone mineralization, cytoplasmic vesicle membrane (... and 4 more)"));
        ...
        assertThat(subject.getPropertiesTableRow(7), hasItems("UniProt", "Q99P91"));
        ...
        assertThat(subject.getLinksInTableRow(2).get(0), is("http://amigo.geneontology.org/amigo/term/GO%3A0032720"));
    ...
    public void showMoreAndLessGeneOntologyTerms() {
        ...
        assertThat(subject.getPropertiesTableRow(2), hasItems("Gene Ontology", "negative regulation of tumor necrosis factor production, melanosome, osteoblast differentiation, integrin binding, cytoplasmic membrane-bounded vesicle, bone mineralization, cytoplasmic vesicle membrane, integral component of plasma membrane, heparin binding, cell adhesion, endomembrane system (show less)"));
