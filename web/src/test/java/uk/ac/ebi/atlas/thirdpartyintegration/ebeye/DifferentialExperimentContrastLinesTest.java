...
public class DifferentialExperimentContrastLinesTest {
    ...
    public void contrastDetailLines() {
        ...
        DifferentialExperiment experiment = new DifferentialExperiment(EXPERIMENT_ACCESSION, new Date(), contrasts, "description", false, true, Collections.EMPTY_SET, "", "", Collections.EMPTY_SET, experimentDesign);
    ...
    public void duplicateContrastDetailLines(){
        ...
        DifferentialExperiment experiment = new DifferentialExperiment(EXPERIMENT_ACCESSION, new Date(), contrasts,
                "description", false, true, Collections.EMPTY_SET, "", "", Collections.EMPTY_SET, experimentDesign);
