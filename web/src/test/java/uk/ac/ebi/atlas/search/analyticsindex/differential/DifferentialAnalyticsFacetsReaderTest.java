...
public class DifferentialAnalyticsFacetsReaderTest {
    ...
    public void normalResultsTest() {
        ...
        when(experimentTraderMock.getExperimentFromCache("E-GEOD-21860", ExperimentType.RNASEQ_MRNA_DIFFERENTIAL)).thenReturn(E_GEOD_21860ExperimentMock);
        when(experimentTraderMock.getExperimentFromCache("E-GEOD-22351", ExperimentType.RNASEQ_MRNA_DIFFERENTIAL)).thenReturn(E_GEOD_22351ExperimentMock);
        when(experimentTraderMock.getExperimentFromCache("E-GEOD-12108", ExperimentType.MICROARRAY_1COLOUR_MRNA_DIFFERENTIAL)).thenReturn(E_GEOD_12108ExperimentMock);

        when(E_MTAB_698ExperimentMock.getDescription()).thenReturn("RNA-seq of vomeronasal tissue from adult male and female mice");
        ...
        when(E_GEOD_21860ExperimentMock.getDescription()).thenReturn("RNA-seq of pancreatic islets from pregnant mice");
        when(E_GEOD_22351ExperimentMock.getDescription()).thenReturn("RNA-seq of mouse spinal cord expressing wild type human TDP-43");
        when(E_GEOD_12108ExperimentMock.getDescription()).thenReturn("Transcription profiling by array of human peripheral blood mononuclear cells infected with Francisella tularensis");

        when(contrastTraderMock.getContrastFromCache("E-MTAB-698", ExperimentType.RNASEQ_MRNA_DIFFERENTIAL, "g1_g2")).thenReturn(G1_G2E_MTAB_698ContrastMock);
        when(contrastTraderMock.getContrastFromCache("E-MEXP-1276", ExperimentType.MICROARRAY_1COLOUR_MRNA_DIFFERENTIAL, "g2_g1")).thenReturn(G2_G1E_MEXP_1276ContrastMock);
        when(contrastTraderMock.getContrastFromCache("E-GEOD-21860", ExperimentType.RNASEQ_MRNA_DIFFERENTIAL, "g1_g2")).thenReturn(G1_G2E_GEOD_21860ContrastMock);
        when(contrastTraderMock.getContrastFromCache("E-GEOD-22351", ExperimentType.RNASEQ_MRNA_DIFFERENTIAL, "g1_g2")).thenReturn(G1_G2E_GEOD_22351ContrastMock);
        when(contrastTraderMock.getContrastFromCache("E-GEOD-12108", ExperimentType.MICROARRAY_1COLOUR_MRNA_DIFFERENTIAL, "g3_g1")).thenReturn(G3_G1E_GEOD_12108ContrastMock);
        when(contrastTraderMock.getContrastFromCache("E-GEOD-12108", ExperimentType.MICROARRAY_1COLOUR_MRNA_DIFFERENTIAL, "g3_g2")).thenReturn(G3_G2E_GEOD_12108ContrastMock);

        when(G1_G2E_MTAB_698ContrastMock.getDisplayName()).thenReturn("sex:'male' vs 'female'");
        ...
        when(G1_G2E_GEOD_21860ContrastMock.getDisplayName()).thenReturn("clinical information:'non-pregnant' vs 'pregnant'");
        when(G1_G2E_GEOD_22351ContrastMock.getDisplayName()).thenReturn("genotype:'expressing human TDP-43' vs 'non transgenic'");
        when(G3_G1E_GEOD_12108ContrastMock.getDisplayName()).thenReturn("'Francisella tularensis Schu S4' vs 'uninfected'");
