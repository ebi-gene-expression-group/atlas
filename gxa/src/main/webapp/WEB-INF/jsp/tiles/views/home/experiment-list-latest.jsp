            ...
            <div class="row margin-bottom-xxlarge">
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments?experimentSet=ENCODE">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/encode_logo.png"/>"/>
                        <h6>
                ...
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments?experimentSet=BLUEPRINT">
                        <img class="margin-bottom-large experiment-thumbnail" "/>
                        <h6>
                ...
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments?experimentSet=FANTOM5">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/fantom_logo.png"/>"/>
                        <h6>
            ...
            <div class="row margin-bottom-xxlarge">
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments/E-PROT-3">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/human_protein_atlas_logo.png"/>"/>
                        <h6>
                ...
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments/E-MTAB-2770">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/ccle_logo.png"/>"/>
                        <h6>
                ...
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments?experimentSet=HipSci">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/hipsci_logo.png"/>"/>
                        <h6>
            ...
            <div class="row margin-bottom-xxlarge">
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments/E-MTAB-5214">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/gtex_logo.png"/>"/>
                        <h6>
                ...
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/baseline/experiments">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/baseline.png"/>"/>
                        <h6>
                ...
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/plant/experiments">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/gramene_logo_big.png"/>"/>
                        <h6>
            ...
            <div class="row">
                <div class="small-4 columns combo text-center padding-top-medium">
                    <a href="${pageContext.request.contextPath}/experiments?experimentSet=Pan-Cancer">
                        <img class="margin-bottom-large experiment-thumbnail" src="<c:url value="/resources/images/pcawg_logo.png"/>"/>
                        <h6>
