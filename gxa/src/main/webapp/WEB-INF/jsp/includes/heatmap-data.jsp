<%--@elvariable id="geneQuery" type="atlas.search.SemanticQuery"--%>
<%--@elvariable id="conditionQuery" type="atlas.search.SemanticQuery"--%>
    ...
    <c:when test="${empty jsonProfiles}">
        {
            ...
            expression="T(atlas.search.SearchDescription).getSimple(geneQuery)"/> "
        }
    </c:when>
    <c:otherwise>
        {
            ...
            "config": {
                ...
                "conditionQuery": "${conditionQuery.toUrlEncodedJson()}",
