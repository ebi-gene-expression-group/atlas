...
var _browseBySpeciesRenderer = __webpack_require__(/*! ./src/browseBySpeciesRenderer.jsx */ 1022);
...
var _BrowseBySpecies = __webpack_require__(/*! ./BrowseBySpecies.jsx */ 1023);
...
var _SpeciesItem = __webpack_require__(/*! ./SpeciesItem.jsx */ 1024);
...
BrowseBySpecies.propTypes = {
    ...
    speciesInfoList: _propTypes2.default.arrayOf(_propTypes2.default.shape({
        species: _propTypes2.default.string.isRequired,
        totalExperiments: _propTypes2.default.number.isRequired,
        baselineExperiments: _propTypes2.default.number.isRequired,
        differentialExperiments: _propTypes2.default.number.isRequired
    })).isRequired
};
...
var StyledEbiIcon = _styledComponents.default.span(_templateObject()); // We don’t use props to set the colour here to avoid creating multiple classes
