    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_expressionAtlasHeatmapHighcharts2.default, {
          ...
          query: Object.assign(this.props.accessKey ? { accessKey: this.props.accessKey } : {}, (this.props.isDifferential ? _CreateQueryObjects.toDifferentialRequestPreferences : _CreateQueryObjects.toBaselineRequestPreferences)(queryObjects))
        })
      )
    );
  }
