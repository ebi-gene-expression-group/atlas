...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/resources/**")
                ...
                .setCacheControl(CacheControl.maxAge(365, TimeUnit.DAYS).mustRevalidate().cachePublic())
                .resourceChain(true).addResolver(
                    new VersionResourceResolver().addFixedVersionStrategy(props.getProperty("projectVersion"), "/**"));
        // If CSS have @import then add:
