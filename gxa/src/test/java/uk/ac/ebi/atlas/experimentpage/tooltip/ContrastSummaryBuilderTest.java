...
public class ContrastSummaryBuilderTest {
    ...
    public void build() {
        ...
        assertThat(
                contrastProperty1,
                is(new ContrastProperty(FACTOR_HEADER, FACTOR_VALUE3, FACTOR_VALUE, ContrastPropertyType.FACTOR)));

        assertThat(
                contrastProperty2,
                is(new ContrastProperty(FACTOR_HEADER2, FACTOR_VALUE4, FACTOR_VALUE2, ContrastPropertyType.FACTOR)));

        assertThat(
                contrastProperty3,
                is(new ContrastProperty("array design", "", "", ContrastPropertyType.SAMPLE)));

        assertThat(
                contrastProperty4,
                is(new ContrastProperty(SAMPLE_HEADER, SAMPLE_VALUE2, SAMPLE_VALUE1, ContrastPropertyType.SAMPLE)));
    }
}
