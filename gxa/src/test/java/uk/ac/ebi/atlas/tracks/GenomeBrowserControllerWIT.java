...
public class GenomeBrowserControllerWIT {
    ...
    public void baselinePlantExperimentGramene() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "gramene", "E-GEOD-55482", "AT4G08874", "g1")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void baselinePlantExperimentEnsemblGenomes() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "ensemblgenomes", "E-GEOD-55482", "AT4G08874", "g1")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void differentialPlantExperimentGramene() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "gramene", "E-GEOD-57252", "GLYMA11G00580", "g1_g6")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void differentialPlantExperimentEnsemblGenomes() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "ensemblgenomes", "E-GEOD-57252", "GLYMA11G00580", "g1_g6")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void baselineWormExperimentWormbaseParaSite() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "wormbaseparasite", "E-MTAB-2812", "WBGene00009892", "g31")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void differentialWormExperimentWormbaseParaSite() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "wormbaseparasite", "E-MEXP-1810", "WBGene00003778", "g3_g1")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void baselineVertebrateExperimentEnsembl() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "ensembl", "E-MTAB-3827", "ENSG00000102970", "g13")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void differentialVertebrateExperimentEnsembl() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "ensembl", "E-GEOD-22351", "ENSMUSG00000029816", "g1_g2")))
                .andExpect(status().isFound())
                .andReturn();
    ...
    public void privateExperimentWithoutAccessKey() throws Exception {
        this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "ensembl", "E-MTAB-3871", "ENSG00000043355", "g1")))
                .andExpect(status().isNotFound())
                .andReturn();
    }
    ...
    public void privateExperimentWithAccessKey() throws Exception {
        MvcResult result = this.mockMvc.perform(get(MessageFormat.format(URL_TEMPLATE, "ensembl", "E-MTAB-3871", "ENSG00000043355", "g1") + "&accessKey=9fc53802-bc7f-4404-bce6-2eb7851d10bf"))
                .andExpect(status().isFound())
                .andReturn();
