...
import uk.ac.ebi.atlas.search.SearchTestUtil;
...
public class BioentitiesSearchControllerGeneQuerySingleSpeciesWithTissueResultsWidgetSIT extends SingleDriverSeleniumFixture {
    ...
    public void baselineResults() {
        ...
        // no tissue results
        MatcherAssert.assertThat(SearchTestUtil.hasResult(baselineCounts, "E-PROT-1"), is(false));
        MatcherAssert.assertThat(SearchTestUtil.hasResult(baselineCounts, "E-MTAB-513"), is(false));
        MatcherAssert.assertThat(SearchTestUtil.hasResult(baselineCounts, "E-MTAB-2836"), is(false));
        MatcherAssert.assertThat(SearchTestUtil.hasResult(baselineCounts, "E-MTAB-1733"), is(false));

        // non tissue results
        MatcherAssert.assertThat(SearchTestUtil.hasResult(baselineCounts, "E-GEOD-26284"), is(true));
    }
